/** @jsx jsx */
import {
  React, jsx, type AllWidgetProps, MessageManager, DataRecordsSelectionChangeMessage, DataSourceStatus,
  type DataSource, type FeatureLayerDataSource, getAppStore, appConfigUtils, type IMState
/*, appActions, DataRecord, IMSqlExpression */ } from 'jimu-core'
// import { JimuMapViewComponent } from 'jimu-arcgis';
import { Button, WidgetPlaceholder, DataActionList, DataActionListStyle, Icon, defaultMessages as jimuDefaultMessages } from 'jimu-ui'
...
export default class Widget extends React.PureComponent<WidgetProps, WidgetState> {
  ...
  render () {
    ...
    if (this.props.config.useMapWidget ? !useMapWidget : !useDataSource) {
      ...
      if ((this.currentData?.count > 1 || enableDataAction) && this.state.loadDataStatus !== DataSourceStatus.NotReady) {
        headerConten = (
