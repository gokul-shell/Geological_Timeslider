...
import { type IMConfig, type OutputSettings, type InputSettings } from '../config'
      ...
      <div css={getStyle(this.props.theme)}>
        <div className={'widget-setting-coordinate-conversion'}>
          <SettingSection className={'map-selector-section'}>
            <SettingRow>
              <div className={'text-truncate setting-text-level-0'} title={this.nls('selectMapWidget')}>
