/** @jsx jsx */
import { css, jsx, classNames, ReactResizeDetector, type IntlShape } from 'jimu-core'
import { UIComponent, type UIComponentProps } from './ui-component'
import { type ToolConfig } from '../../../config'
import { type LayoutJson, type GroupJson, type HiddenElementNames, type ToolJson } from '../config'
          ...
          >
            {children.map((key, index) => {
              ...
              if (layoutJson.elements[key].type === 'GROUP') {
                ...
                const toolName = (layoutJson.elements[key] as ToolJson).toolName
            ...
            {this.props.isMainGroup && this.props.isMobile && <ReactResizeDetector handleWidth handleHeight onResize={this.onResize} />}
