...
import { type LayoutJson, type GroupJson, type LayoutItemJson, type HiddenElementNames } from './config'
      ...
      return (
        <div className='exbmap-ui esri-ui-inner-container map-tool-layout' css={this.getStyle()}>
          {Object.keys(layoutJson.layout).map((key, index) => {
            ...
            return (
              <Group
                mapWidgetId={this.props.mapWidgetId} className={elementItem.className} style={elementItem.style}
                isMobile={this.props.isMobile} isMainGroup
