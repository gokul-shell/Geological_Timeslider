import { type SpatialRelationship, type Units } from '@esri/arcgis-rest-types'
import { type ImmutableObject, type ImmutableArray, type SqlExpression, type UseDataSource, type IconResult, type OrderByOption } from 'jimu-core'
