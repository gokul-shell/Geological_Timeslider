/** @jsx jsx */
import { React, jsx, css, classNames, CONSTANTS, type FeatureLayerDataSource, type ImmutableObject, type DataRecord, type FeatureDataRecord, type QueryParams } from 'jimu-core'
...
export function PagingList (props: PagingListProps) {
  const { widgetId, outputDS, queryItem, queryParams, resultCount, records, onRenderDone, direction, onEscape, defaultPageSize = CONSTANTS.DEFAULT_QUERY_PAGE_SIZE } = props
  ...
  return (
    <div onKeyUp={handleKeyUp} className={classNames({ vertical: direction === ListDirection.Vertical })} css={getStyle(isAutoHeight)}>
