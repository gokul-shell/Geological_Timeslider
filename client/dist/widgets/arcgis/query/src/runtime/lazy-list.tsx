...
export function LazyList (props: LazyListProps) {
  ...
  const allDataItemsLoadedRef = hooks.useLatest(records?.length === resultCount)
  ...
  return (
    <div onKeyUp={handleKeyUp} className={classNames({ vertical: direction === ListDirection.Vertical })} css={getStyle(isAutoHeight)} ref={resultContainerRef}>
      <div className='list-items px-3' role='listbox'>
