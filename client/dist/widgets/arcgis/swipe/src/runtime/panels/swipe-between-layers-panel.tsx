...
export function SwipeBetweenLayersPanel (props: SwipeBetweenLayersPanelProps) {
  const { swipeMapViewList, activeMapView, isAllowDeactivateLayers, handlePanelSelectedLeadingLayers, handlePanelSelectedTrailingLayers, runtimeAddedLayers, handleRuntimePanelSelectedLeadingLayers, handleRuntimePanelSelectedTrailingLayers } = props
