...
const SwipeTemplates = (props: SwipeTemplatesProps) => {
  ...
  const SimpleTemplateTip = (
    <div className='w-100 d-flex'>
      ...
      <Tooltip title={ translate('simpleTemplateTip')} showArrow placement='left'>
  ...
  const AdvancedTemplateTip = (
    <div className='w-100 d-flex'>
      ...
      <Tooltip title={translate('advancedTemplateTip')} showArrow placement='left'>
        <span className='mt-1 ml-2'>
          <InfoOutlined />
        </span>
      </Tooltip>
  ...
  return (
    <SettingSection title={translate('chooseTemplateTip')}>
      <CollapsablePanel
