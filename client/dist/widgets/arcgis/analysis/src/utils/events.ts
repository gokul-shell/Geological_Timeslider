...
import { type AnalysisGPJobStatus, type AnalysisJobResults } from 'analysis-shared-utils'
import { type AnalysisGPJobSubmited } from '../config'
 ...
 * @param data
 */
export function notifyJobSubmited (htmlContainer: HTMLElement, data?: AnalysisGPJobSubmited): void {
