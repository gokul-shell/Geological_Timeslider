...
import { Label, NumericInput, Radio, Select, Option, Switch, Tooltip, defaultMessages as jimuUIDefaultMessages, utils, Checkbox } from 'jimu-ui'
 ...
 */
  updateResultAreaProperty = () => {
    const updatedColor = new this.EsriColor(utils.getColorValue(this.state.resultAreaColor))
    updatedColor.a = 0.5
    const resultAreaProps: __esri.ResultAreaPropertiesExtend = {
      ...
      unit: this.state.shapeUnit as __esri.LinearUnits,
      areaUnit: ('square-' + this.state.shapeUnit) as __esri.AreaUnits,
      color: {
        color: updatedColor.toRgba(),
        haloOpacity: defaultConfiguration.traceResultAreaSettings.resultAreaProperties.color.haloOpacity,
        hex: utils.getColorValue(this.state.resultAreaColor)
      },
        ...
        <SettingSection>
          <SettingRow>
            <Label aria-label={this.nls('resultAreaLabel')} title={this.nls('resultAreaLabel')}
              ...
              <div className='w-100 text-truncate flex-grow-1 setting-text-level-1'>
          ...
          <SettingRow label={this.nls('createResultAreaLabel')}>
            ...
            <React.Fragment>
              ...
              <SettingRow flow={'wrap'} >
                <Label tabIndex={0} aria-label={this.nls('shapeLabel')} title={this.nls('shapeLabel')}
                  className='w-100 d-flex'>
                  <div className='text-truncate flex-grow-1 setting-text-level-2'>
                    {this.nls('shapeLabel')}
                  </div>
                </Label>
              </SettingRow>
              ...
              <div className={'pt-1'}>
                <SettingRow>
                  ...
                  <Select menuRole={'menu'} aria-label={this.state.shapeUnit.toString()} style={{ width: 129 }} className={'pl-2'}
