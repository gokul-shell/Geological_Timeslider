...
import {
  Legend, useTheme, unuseTheme, am4themes_dark, create,
  MouseCursorStyle, percent, PieChart, PieSeries
...
export class WroChart extends React.PureComponent<any, State> {
  ...
  initChart = async (data?: any): Promise<any> => {
    try {
      ...
      const pieChart = create(this.chartRef.current, PieChart)
      pieChart.rtl = isRTL
      pieChart.radius = percent(90)
      ...
      const legend = pieChart.legend = new Legend()
