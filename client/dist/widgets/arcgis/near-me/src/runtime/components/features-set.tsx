...
export default class FeaturesSet extends React.PureComponent<Props, State> {
   ...
   */
  createFeatureItem = (callFeatureDetailsClick: boolean) => {
    const featureRecord = this.props.selectedRecord as any
    ...
    const displayTitle = this.props.popupTitleField && this.props.isExpanded ? this.displayPopupTitle() : this.nls('approximateDistance')
    individualFeatureItem = (
      <div>
        {/* show approximateDistanceUI - closet, proximity with expanded list */}
        {(this.props.approximateDistanceUI && (this.props.showDistFromInputLocation || (this.props.popupTitleField && this.props.isExpanded))) &&
          <div className='approximateDist-container border-bottom'>
            ...
            {this.props.showDistFromInputLocation &&
