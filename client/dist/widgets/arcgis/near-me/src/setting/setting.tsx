...
import { Alert, Label, CollapsablePanel, defaultMessages as jimuUIDefaultMessages } from 'jimu-ui'
import { type JimuMapView, MapViewManager } from 'jimu-arcgis'
import defaultMessages from './translations/default'
import { getStyle } from './lib/style'
import { type DataSourceOptions, type IMConfig, type LayersInfo, type LayerDsId, type FontStyleSettings, AnalysisTypeName, type SummaryFieldsInfo, type ConfigInfo, type SummaryAnalysis } from '../config'
  ...
  getInitSchema = (label: string = '', summaryFields: SummaryFieldsInfo[]): DataSourceSchema => {
    ...
    summaryFieldsSchema?.forEach((fieldSchema, index) => {
      if (index === 0) {
        ...
        fields[fieldSchema?.jimuName + index] = fieldSchema
      }
    })
