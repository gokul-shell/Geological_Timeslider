...
import { React, jsx, type IntlShape, type IMThemeVariables, Immutable, type IMFieldSchema, JimuFieldType } from 'jimu-core'
...
import { type AssetLayersSettings, type ElevationType } from '../../config'
...
export default class AssetSettingPopper extends React.PureComponent<Props, IState> {
  ...
  constructor (props) {
    ...
    if (!this.props.hasSupportForZValue) {
      this.elevationTypeOptions = intersectingLayersElevationTypeWithoutZ
    } else {
      //layer supports z value, include z value option from elevation drop down
      this.elevationTypeOptions = intersectingLayersElevationType
    }
