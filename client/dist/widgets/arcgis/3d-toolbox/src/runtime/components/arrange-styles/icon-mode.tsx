/** @jsx jsx */
import { React, jsx, type ImmutableObject, type ImmutableArray, type AppMode, hooks } from 'jimu-core'
...
export const IconMode = React.memo((props: Props) => {
  ...
  const _closePoppup = React.useCallback(() => {
    ...
    btnRefFor508?.current?.focus() // 508 focus on PreviewBtn
    ...
    <React.Fragment>
      ...
      >
        <div className={'content-container'} css={getPopperStyle(theme)}>
          {/* header */}
          <div className={'popper-header d-flex px-3 pt-2 align-items-center justify-content-between ' + FOCUSABLE_CONTAINER_CLASS}>
