/** @jsx jsx */
import { React, jsx, type ImmutableObject, type AppMode, hooks } from 'jimu-core'
import { Button, Label, Loading, LoadingType, FOCUSABLE_CONTAINER_CLASS, useTrapFocusByBounderyNodes, defaultMessages as jimuUIMessages } from 'jimu-ui'
...
export const ToolPanel = React.memo((props: Props) => {
  ...
  const { updateSliceWidget, destorySliceWidget } = useSlice({
    jimuMapView: props.jimuMapView,
  ...
  const destoryWidget = React.useCallback(() => {
    ...
    destoryShadowCastWidget, destoryLineOfSightWidget, destorySliceWidget])
  ...
  useTrapFocusByBounderyNodes(firstNodeRefFor508, lastNodeRefFor508, focusLoopVersionState)
  ...
  return (
    <div className={'p-2 w-100 ' + (_isShow ? 'd-block ' + FOCUSABLE_CONTAINER_CLASS : 'd-none')} css={getStyle(theme)}>
      ...
      <div className="tool-content">
        ...
        <div className="tool-footer w-100 px-3 mt-1 mb-2">
          {/* cancel slicing btn */}
