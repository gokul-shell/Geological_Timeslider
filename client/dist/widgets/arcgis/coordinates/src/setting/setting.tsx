...
import { Button, defaultMessages as jimuiMessages, Icon, Label, NumericInput, Radio, Switch, Tooltip } from 'jimu-ui'
        ...
        <Fragment>
          ...
          >
            ...
            <SettingRow flow='wrap' label={displayOrderLabel}>
              <div role='radiogroup' className='mb-3' aria-label={displayOrderLabel}>
