...
import { Link, Select, Tooltip, defaultMessages as jimuiDefaultMessages, Label, Radio, Button, NumericInput } from 'jimu-ui'
import defaultMessages from './translations/default'
import { SettingRow, SettingSection } from 'jimu-ui/advanced/setting-components'
import { InfoOutlined } from 'jimu-icons/outlined/suggested/info'
import { type CoordinateConfig, ElevationUnitType, type MapInfo } from '../config'
import { type JimuMapView, type JimuMapViewGroup, loadArcGISJSAPIModules } from 'jimu-arcgis'
      ...
      <div className='w-100 h-100 system-config-panel'>
        ...
        <SettingSection>
          ...
          <SettingRow
            ...
            truncateLabel={false}
          >
            <div role='radiogroup' className='mb-3' aria-label={elevationUnitLabel}>
