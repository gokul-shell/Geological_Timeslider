/** @jsx jsx */
import { React, jsx, css, type ThemeSliderVariant, type ImmutableObject, lodash, type ImmutableArray } from 'jimu-core'
import {
...
export const ViewNavigation = (props: ViewNavigationProps) => {
  ...
  return <div className="navigation" css={[style, advanceStyle, containerPaddingStyle]} {...others}>
    {type === 'nav' && <Navigation
      role="tablist"
      vertical={vertical}
      isActive={isActive}
