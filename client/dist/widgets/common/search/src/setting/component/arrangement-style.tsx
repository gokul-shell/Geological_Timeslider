/** @jsx jsx */
import { React, css, jsx, polished, defaultMessages as jimuCoreDefaultMessage, hooks, classNames } from 'jimu-core'
    ...
    <SettingSection title={nls('arrangementStyle')} css={STYLE}>
      <SettingRow>
        <div>
          ...
          >
            <Icon className='style-img w-100 h-100' icon={require('../assets/arrangement1.png')}/>
          </Button>
          <Button
            type='tertiary'
          ...
          >
            <Icon className='style-img w-100 h-100' icon={require('../assets/arrangement2.png')}/>
          </Button>
          <Button
            type='tertiary'
          ...
          >
            <Icon className='style-img w-100 h-100' icon={require('../assets/arrangement3.png')}/>
          </Button>
        </div>
      </SettingRow>
    </SettingSection>
