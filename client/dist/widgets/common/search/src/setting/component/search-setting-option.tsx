/** @jsx jsx */
import { React, css, jsx, type UseDataSource, type ImmutableArray, LinkType, Immutable, defaultMessages as jimuCoreDefaultMessage, hooks } from 'jimu-core'
import { type SettingChangeFunction } from 'jimu-for-builder'
import { SettingSection, SettingRow, LinkSelector, type IMLinkParam, OpenTypes, type IMSearchSuggestionConfig, type SearchSuggestionConfig, SearchSuggestionSetting, SearchGeneralSetting } from 'jimu-ui/advanced/setting-components'
import { type IMConfig, SearchResultView, MAX_RESULT, DEFAULT_MAX_RESULT } from '../../config'
      ...
      <SettingRow role='group' aria-label={nls('searchResult')}>
        ...
        >
          ...
          {searchResultView === SearchResultView.ResultPanel && <SettingRow>
            <div className='cursor-pointer d-flex align-items-center' onClick={handleAutoSelectChange} aria-label={nls('autoSelect')}>
