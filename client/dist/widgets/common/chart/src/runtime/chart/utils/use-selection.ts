import { React, type IMState, ReactRedux, lodash, MessageManager, DataRecordsSelectionChangeMessage, type DataSource, hooks } from 'jimu-core'
import { type SelectionData, type SelectionIndexes, SelectionSource } from 'jimu-ui/advanced/chart'
...
const getSelectionIndexes = (
  ...
  const indexes = (selectionIds?.length) ? selectionIds : [-1]
