...
import { defaultMessages as jimuiDefaultMessage, NumericInput, TextInput, AdvancedButtonGroup, Button } from 'jimu-ui'
...
const Guide = (props: GuideProps) => {
  ...
  return (<GuideCollapse
    ...
    <SettingRow truncateLabel={true} level={2} label={translate('labelAlign')} aria-label={translate('labelAlign')} role='group' flow='wrap'>
      <SettingRow
        truncateLabel={true}
        level={3}
