...
import { type IWebChart, type WebChartSeries, type ChartDataSource } from '../../../../../config'
...
import { type WebChartAxis, type WebChartScatterPlotSeries } from 'jimu-ui/advanced/chart'
