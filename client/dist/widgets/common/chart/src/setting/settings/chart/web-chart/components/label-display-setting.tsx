...
const Root = styled('div')((props) => ({
  ...
  backgroundColor: props.theme.colors.palette.light[200]
}))
...
export const LabelDisplaySetting = (props: LabelDisplaySettingProps): React.ReactElement => {
  ...
  return (
    <Root className={classNames(className, 'label-display-setting')}>
       <Label check centric className='justify-content-start align-items-center setting-text-level-3'>
            <Checkbox
          ...
          <Label check centric className='justify-content-start align-items-center mt-2 setting-text-level-3'>
            <Checkbox
