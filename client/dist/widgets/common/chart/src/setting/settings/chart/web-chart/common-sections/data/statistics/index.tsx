...
import { Select, defaultMessages as jimuiDefaultMessage, NumericInput } from 'jimu-ui'
...
export const StatisticsDataSetting = (props: StatisticsDataSettingProps): React.ReactElement => {
  ...
  const showMaxCategories = categoryType !== CategoryType.ByField && !isTimeBinning
  ...
  const handleCategoryTypeChange = (evt: React.MouseEvent<HTMLSelectElement>): void => {
    ...
    onChange?.(Immutable([serie]), { chartDataSource, query: chartDataSource.query })
  }
