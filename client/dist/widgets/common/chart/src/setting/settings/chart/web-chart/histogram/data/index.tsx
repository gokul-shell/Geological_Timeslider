  ...
  return (
    <>
      ...
      <SettingRow level={2} label={translate('bins')} flow='wrap'>
        ...
        <SettingRow className='w-100' level={2} label={translate('dataLabel')} flow='no-wrap'>
          <Switch
        ...
        <SettingRow className='w-100' level={2} label={translate('hoverLabel')} flow='no-wrap'>
          <Switch
