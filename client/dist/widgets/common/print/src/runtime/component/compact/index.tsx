...
import { type IMConfig, type PrintTemplateProperties, type IMPrintTemplateProperties, type IMPrintResultListItemTyle, PrintResultState, type MapView } from '../../../config'
...
const CompactPrint = (props: Props) => {
  const { config, templateList, jimuMapView, errorTip, id, locale } = props
  ...
  const confirmPrint = async () => {
    ...
    print({
      ...
      printTemplateProperties: await initTemplateProperties(selectedTemplate, jimuMapView, locale)
    }).then(res => {
