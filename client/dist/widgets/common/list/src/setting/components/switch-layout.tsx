/** @jsx jsx */
import { React, jsx, css, type BrowserSizeMode, type IMAppConfig, defaultMessages as jimuCoreDefaultMessage, hooks } from 'jimu-core'
import { type SettingChangeFunction } from 'jimu-for-builder'
import { SettingRow } from 'jimu-ui/advanced/setting-components'
import { ListLayout, Status, type IMConfig } from '../../config'
...
import { setLayoutAuto, setLayoutCustom, type Option } from '../utils/utils'
...
const LayoutSetting = (props: LayoutSettingProps) => {
  ...
  const handleConfirm = () => {
    const regularLayoutId = searchUtils.findLayoutId(layouts[Status.Default], browserSizeMode, mainSizeMode)
