/** @jsx jsx */
import { React, css, jsx, classNames, type IMSizeModeLayoutJson, type LayoutItemConstructorProps, type IMLayoutJson, polished, hooks } from 'jimu-core'
...
export const DrapZone = React.forwardRef((props: DropZoneProps, ref) => {
