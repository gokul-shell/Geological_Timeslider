import { WidgetType, LayoutItemType, type LayoutItemConstructorProps, type IMLayoutJson, type LayoutInfo, getAppStore, appActions, ReactRedux, type IMState } from 'jimu-core'
...
export const removeLayoutItem = (layoutInfo: LayoutInfo) => {
  ...
  appConfigAction.removeLayoutItem(layoutInfo, true, false)
