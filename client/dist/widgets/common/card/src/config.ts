...
import { type FillType, type BorderStyle, type ImageParam, type FourSidesUnit, type BoxShadowStyle } from 'jimu-ui'
import { type IMLinkParam } from 'jimu-ui/advanced/setting-components'

import { type AnimationSetting, TransitionType, TransitionDirection } from 'jimu-core'
