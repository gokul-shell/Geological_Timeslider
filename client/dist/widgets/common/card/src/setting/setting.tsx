        ...
        >
          <SettingRow role='group' aria-label={this.formatMessage('classic')}>
            <div className='style-group w-100'>
              <div className='template-type mb-3 d-flex align-items-center'>
                ...
                <Tooltip
                  ...
                  placement='left'
                >
                  <Button className='inline-block ml-2 tooltip-icon-con' aria-label={this.formatMessage('classicTips')}>
            ...
            <div className='style-group advance-style-group w-100'>
              <div className='template-type mb-3 d-flex align-items-center'>
                ...
                <Tooltip
                  ...
                  placement='left'
                >
                  <Button className='inline-block ml-2 tooltip-icon-con' aria-label={this.formatMessage('classicHoverTips')}>
                    <InfoOutlined autoFlip/>
                  </Button>
                </Tooltip>
              </div>
        ...
        <SettingSection>
          ...
          <SettingRow flow='wrap'>
            <div className='w-100 d-flex align-items-center'>
              <Button className='resetting-template flex-grow-1 text-left' title={this.formatMessage('chooseOtherTemplateTip')} type='tertiary' onClick={this.handleResetItemstyleClick}>
    ...
    return (
      <SettingSection role='group' aria-label={this.formatMessage('default')}>
        <CollapsablePanel
          ...
          <SettingRow flow='wrap'>
            {this.rednerBgSetting(Status.Default)}
          </SettingRow>
        </CollapsablePanel>
      </SettingSection>
    )
