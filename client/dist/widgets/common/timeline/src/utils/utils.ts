import { type DataSource, dataSourceUtils, dateUtils, type FeatureLayerDataSource, type MapServiceDataSource, Immutable, DataSourceTypes } from 'jimu-core'
import { type MapDataSourceImpl } from 'jimu-arcgis/arcgis-data-source'
import { ArcGISDataSourceTypes } from 'jimu-arcgis'
import { type DateTimeUnits, type DateUnitInputValue, type DateWeekUnits, type TimeUnits } from 'jimu-ui/advanced/style-setting-components'
...
export function getTimeSettingsFromHonoredWebMap (dataSources: { [dsId: string]: DataSource }): timeSettings {
