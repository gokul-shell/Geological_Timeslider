/** @jsx jsx */
import {
  React, jsx, type IMThemeVariables, Immutable, type IntlShape, type DataSource, type ImmutableObject, type UseDataSource, type ImmutableArray, dateUtils, AllDataSourceTypes
} from 'jimu-core'
    ...
    return (
      <div className='time-panel w-100 h-100' css={getStyleForTimePanel(theme)}>
        ...
        <SettingSection
          ...
          className={`border-0 ${dataSourceType !== AllDataSourceTypes.WebMap ? 'pt-0' : ''}`}
        >
          <SettingRow>
            <TimeSpan
              intl={intl}
        ...
        <SettingSection className='pt-0'>
          ...
          <SettingRow className='mt-1'>
            <Select size='sm' onChange={this.onAccuracyChanged} value={accuracy}>
              {
