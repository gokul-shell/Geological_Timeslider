/** @jsx jsx */
import { jsx, React, type IconResult, type IMIconResult, useIntl, useTheme, defaultMessages } from 'jimu-core'
...
export const IconSelector = React.memo((props: Props) => {
  ...
  // share icon updates ,#13386#issuecomment-4030639
  const SHARE_ICONS = [
    ...
    for (let i = 0, len = SHARE_ICONS.length; i < len; i++) {
      resList.push({
        ...
        properties: {
          ...
          color: theme.colors.palette.light[900],
