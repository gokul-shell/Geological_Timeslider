...
export const DataUrlInput = (props: UrlInputProps) => {
  const { widgetId, onChange, setErrorMsg, nextOrder, multiDataOptions } = props
  ...
  return <div className='data-url-input w-100 h-100 p-3' css={style}>
    <div>
    ...
    <div className='mt-3'>
      <Button onClick={onAdd} type='primary' disabled={!urlResult.value || !urlResult.valid} className='px-3 w-100' title={translate('add')} aria-label={translate('add')}>
        {translate('add')}
      </Button>
    </div>
