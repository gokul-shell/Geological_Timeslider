/** @jsx jsx */
import {
  React, type IMState, type IMThemeVariables, type SerializedStyles, type ImmutableArray, type IMUseDataSource,
  Immutable, type ImmutableObject, css, jsx, type Expression, type UseDataSource, expressionUtils, CONSTANTS, DataSourceManager,
  ImageDisplayQualityMode, AllDataSourceTypes
} from 'jimu-core'
import { type AllWidgetSettingProps } from 'jimu-for-builder'
import { SettingSection, SettingRow, LinkSelector, type IMLinkParam } from 'jimu-ui/advanced/setting-components'
import { Select, type ImageParam, type CropParam, ImageFillMode, Slider, NumericInput, Tabs, Tab, Tooltip, imageUtils } from 'jimu-ui'
import { ImageSelector } from 'jimu-ui/advanced/resource-selector'
import { DataSourceSelector } from 'jimu-ui/advanced/data-source-selector'

import { type IMConfig, type ShapeStyle, ImgSourceType, DynamicUrlType } from '../config'
      ...
      <div css={this.getStyle(this.props.theme)} className='jimu-widget'>
        <div className='widget-setting-image'>
          <SettingSection>
            ...
            {/* The component is used to set image display quality by Jimu-ui Slider component
              * Hide image display quality for developer edition now
              * Should not be affected by whether connected to the data.
              */}
            {!window.jimuConfig.isDevEdition &&
            functionConfig?.imageParam?.originalUrl &&
            imageUtils.canUseImageDisplayQuality(this.props.config.functionConfig?.imageParam) &&
