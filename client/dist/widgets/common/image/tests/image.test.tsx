...
jest.mock('../src/runtime/components/image-gallery', () => {
  return {
    ...jest.requireActual<any>('../src/runtime/components/image-gallery'),
...
jest.mock('../src/runtime/components/attachment-component', () => {
  return {
    ...jest.requireActual<any>('../src/runtime/components/attachment-component'),
...
jest.mock('../src/runtime/components/symbol-component', () => {
  return {
    ...jest.requireActual<any>('../src/runtime/components/symbol-component'),
