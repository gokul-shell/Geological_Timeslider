import { React, Immutable, getAppStore, appActions, type UseDataSource, type ImmutableObject, DataSourceTypes } from 'jimu-core'
...
jest.mock('jimu-core', () => {
  ...
  return {
    ...
    moduleLoader: { loadModules: jest.fn(), loadModule: jest.fn().mockResolvedValue({ }) }
  }
})
