...
any> {
  ...
  constructor (props) {
    ...
    async function getGeoenrichmentServiceUrl () {
      ...
      // Determine if a Portal proxy is setup for GE service by looking for 'sharing/servers' or '/appservices/' in path.  If so assume it is pointing to AGO GE service
      self.portalOnlineGEProxy = self.geoenrichmentServiceUrl.includes('sharing/servers') || self.geoenrichmentServiceUrl.includes('/appservices/')
