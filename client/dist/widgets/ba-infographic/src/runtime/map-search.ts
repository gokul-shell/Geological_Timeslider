...
export default class MapSearch {
  ...
  public static registerCallbacks (
    ...
    if (view.ui._components?.length > 0) {
    ...
    //   console.log('%c  MAP SEARCH: caught searchResults event ', 'color:yellow;font-size:8pt;', e)
    // })

    // window.addEventListener('searchResults', (e: any) => {
    //     // if (this.props.id && (this.props.id === e.detail.id)) {
    //     console.log("%c MapActions: caught searchResults ", 'color:#0279c1',e.detail);
    //
    //     if (e.detail.type == 'location') {
    //         const address:string = e.detail.address;
    //         const lat:number = e.detail.location.lat;
    //         const lon:number = e.detail.location.lon;
    //         console.log("%c ==> searchResults detail", 'color:#0279c1',address, lat, lon);
    //
    //         // TODO: update map with geometry
    //         // TODO: update infographic with geometry
    //     }
    //     else if (e.detail.type == 'geography') {
    //         console.log("%c ==> searchResults areaId=" + e.detail.areaId, 'color:#0279c1');
    //         console.log("%c ==> searchResults geometry=", 'color:#0279c1', e.detail.geometry);
    //
    //         // TODO: update map with geometry
    //         // TODO: update infographic with geometry
    //     }
    //     // this.updateState('selectedReport', e.detail.value)
    //     //this.onPreviewClick()
    //     // }
    // })
    ...
    const envUrl: string = getGeocoderUrl(env)
