...
import { Switch, Select, DistanceUnits, type LinearUnit, Icon, Button, NumericInput, Collapse, utils as uiUtils } from 'jimu-ui'
    ...
    return (
      <div className='hsidebar-layout-setting' css={this.getStyle()}>
        <SettingSection title={formatMessage('panel')} role='group' aria-label={formatMessage('panel')}>
          <SettingRow role='group' aria-label={formatMessage('dockSide')} label={formatMessage('dockSide')} flow='wrap'>
