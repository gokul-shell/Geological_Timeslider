          ...
          {this.props.config.mode === 'new' && <React.Fragment>
            <SettingRow>
              <div className="section-title">
                ...
                <Switch aria-label={this.nls('sendDataToSurveyTitle')} aria-describedby={this.props.config.activeLinkData ? `survey_${this.props.id}_sendDataToSurveyDesc` : ''} className="can-x-switch" checked={this.props.config.activeLinkData}
